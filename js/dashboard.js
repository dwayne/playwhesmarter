...
var _dwayne$playwhesmarter$Dashboard$viewNumber = function (number) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _dwayne$playwhesmarter$Dashboard$viewResult = function (_p0) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mb-4 px-2'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('d-inline-block p-2 text-center border border-secondary rounded bg-light'),
					_1: {
						ctor: '::',
...
var _dwayne$playwhesmarter$Dashboard$decodePlayWheResult = A5(
	_elm_lang$core$Json_Decode$map4,
	_dwayne$playwhesmarter$Dashboard$PlayWheResult,
...
var _dwayne$playwhesmarter$Dashboard$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _dwayne$playwhesmarter$Dashboard$init,
		update: _dwayne$playwhesmarter$Dashboard$update,
		view: _dwayne$playwhesmarter$Dashboard$view,
...
if (typeof _dwayne$playwhesmarter$Dashboard$main !== 'undefined') {
    _dwayne$playwhesmarter$Dashboard$main(Elm['Dashboard'], 'Dashboard', undefined);
}
