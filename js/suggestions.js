...
var _dwayne$playwhesmarter$Suggestions$timesOfDay = {
	ctor: '::',
	_0: 'Morning (10:30am)',
	_1: {
		ctor: '::',
...
var _dwayne$playwhesmarter$Suggestions$commaSep = function (numbers) {
	return A2(
		_elm_lang$core$String$join,
		', ',
		A2(_elm_lang$core$List$map, _elm_lang$core$Basics$toString, numbers));
};
var _dwayne$playwhesmarter$Suggestions$viewSuggestions = F6(
	function (title, prefix, marks, allMarks, lines, allLines) {
		var toRow = F3(
			function (tod, ns, ls) {
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(tod),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										_dwayne$playwhesmarter$Suggestions$commaSep(ns)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_dwayne$playwhesmarter$Suggestions$commaSep(ls)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
		...
		var rows = A4(_elm_lang$core$List$map3, toRow, _dwayne$playwhesmarter$Suggestions$timesOfDay, marks, lines);
		var header = A2(
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Time of day'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										A2(_elm_lang$core$Basics_ops['++'], prefix, ' marks')),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											A2(_elm_lang$core$Basics_ops['++'], prefix, ' lines')),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('mb-3 text-center'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Today\'s ', title)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('col-md-6 offset-md-3'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('table table-sm table-bordered'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
														...
														{ctor: '[]'},
														{
															...
															_0: A2(
																_elm_lang$html$Html$th,
																{
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('table-dark'),
																		_1: {ctor: '[]'}
																	}
																},
																{
															...
															_1: {
																...
																_0: A2(
																	...
																	{ctor: '[]'},
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text(
																			_dwayne$playwhesmarter$Suggestions$commaSep(allMarks)),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
																...
																_1: {
																	...
																	_0: A2(
																		...
																		{ctor: '[]'},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(
																				_dwayne$playwhesmarter$Suggestions$commaSep(allLines)),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('h4 text-center'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Coming under:'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _dwayne$playwhesmarter$Suggestions$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _dwayne$playwhesmarter$Suggestions$init,
		update: _dwayne$playwhesmarter$Suggestions$update,
		view: _dwayne$playwhesmarter$Suggestions$view,
...
var Elm = {};
Elm['Suggestions'] = Elm['Suggestions'] || {};
if (typeof _dwayne$playwhesmarter$Suggestions$main !== 'undefined') {
    _dwayne$playwhesmarter$Suggestions$main(Elm['Suggestions'], 'Suggestions', undefined);
}
